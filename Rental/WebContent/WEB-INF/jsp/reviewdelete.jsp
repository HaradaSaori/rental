...
<input type="hidden" value="${reviewdata.castId}" name="castId">
<input type="hidden" value="${reviewdata.userId}" name="userId">
<input type="hidden" value="${reviewdata.revId}" name="revId">
